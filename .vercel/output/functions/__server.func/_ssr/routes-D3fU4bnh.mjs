...
import { C as __exportAll } from "./router-Bq88JwJI.mjs";
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/routes-D3fU4bnh.js
			...
			children: [
				...
				TABS.map(({ id, label, short }) => {
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						"aria-label": label,
						title: label,
						className: cn("bottom-tab-btn group relative z-[3] flex min-h-[48px] w-full items-center justify-center rounded-[1.25rem] px-0.5 py-2 sm:min-h-[52px]", "transition-[transform,opacity] duration-200 ease-out", "active:scale-[0.94] touch-manipulation select-none"),
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: cn("bottom-tab-label text-center text-[12px] font-bold uppercase leading-none tracking-[0.06em] sm:text-[13px] sm:tracking-[0.08em]", isGrok ? active ? "text-[#ffd0d6]" : "text-white/55" : active ? "text-sky-50" : "text-white/55"),
							children: short
						}), active ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							"aria-hidden": true,
							className: cn("absolute bottom-1.5 h-[2px] w-3.5 rounded-full", isGrok ? "bg-[#ff8a96] shadow-[0_0_8px_rgba(255,90,110,0.8)]" : "bg-sky-200 shadow-[0_0_8px_rgba(140,200,255,0.75)]")
						}) : null]
					}, id);
				})
			]
...
*/
var RvFaxApp = (0, import_react.lazy)(() => import("./RvFaxApp-4iosCwmy.mjs").then((m) => ({ default: m.RvFaxApp })));
var RvGrokApp = (0, import_react.lazy)(() => import("./RvGrokApp-CXUIZ8g4.mjs").then((m) => ({ default: m.RvGrokApp })));
var RvTowApp = (0, import_react.lazy)(() => import("./RvTowApp-Dw2zWHYZ.mjs").then((m) => ({ default: m.RvTowApp })));
var RvCalApp = (0, import_react.lazy)(() => import("./RvCalApp-BI5ET6MO.mjs").then((m) => ({ default: m.RvCalApp })));
var RvTripsApp = (0, import_react.lazy)(() => import("./RvTripsApp-t5VDJY8V.mjs").then((m) => ({ default: m.RvTripsApp })));
var RvShareApp = (0, import_react.lazy)(() => import("./RvShareApp-z6Jst0JF.mjs").then((m) => ({ default: m.RvShareApp })));
var MoreApp = (0, import_react.lazy)(() => import("./MoreApp-CZHTRmEX.mjs").then((m) => ({ default: m.MoreApp })));
