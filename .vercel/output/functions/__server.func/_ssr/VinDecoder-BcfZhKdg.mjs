...
import { n as scrollFieldIntoVisibleArea, p as cn, r as useKeyboardInset } from "./routes-DxgqAedY.mjs";
import { a as normalizeVin$1, i as isValidVinFormat, r as decodeVinViaApi } from "./router-B7uJEg2g.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/VinDecoder-BcfZhKdg.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var VinScanner = (0, import_react.lazy)(() => import("./VinScanner-CbuhtfQ-.mjs").then((m) => ({ default: m.VinScanner })));
