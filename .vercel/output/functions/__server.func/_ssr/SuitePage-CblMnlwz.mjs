...
import { rt as Ellipsis } from "../_libs/lucide-react.mjs";
import { a as PAGE_COPY, i as PAGE_ACCENT, l as useShellNavOptional, o as MetalVerifiedTrue, r as useKeyboardInset, u as cn } from "./routes-D3fU4bnh.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/SuitePage-CblMnlwz.js
...
function usePullToReset(scrollRef, onReset, opts) {
	...
	(0, import_react.useEffect)(() => {
		...
		const isBlockedTarget = (t) => {
			...
			return Boolean(t.closest("[data-no-pull-reset], .select-sheet-root, input, textarea"));
		};
		const onStart = (e) => {
