...
import { J as Info, K as Landmark, R as MapPin, _ as Star, b as SlidersHorizontal, gt as Car, ht as Check, mt as ChevronDown, nt as ExternalLink, st as DollarSign, tt as FileText, ut as CircleAlert, wt as ArrowLeftRight, y as Sparkles, yt as Building2 } from "../_libs/lucide-react.mjs";
import { c as hapticSnap, d as preloadHaptics, f as useShellNavOptional, l as hapticSnapEnd, p as cn, u as hapticSnapStart } from "./routes-DxgqAedY.mjs";
import { a as SuitePage } from "./SuitePage-CCsMenKq.mjs";
import { v as LENDERS_CATALOG } from "./router-B7uJEg2g.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/RvCalApp-B7gkuQnT.js
...
*/
function RollPicker({ options, value, onChange, "aria-label": ariaLabel, className, itemHeight = 36, visible = 3 }) {
	const scrollerRef = (0, import_react.useRef)(null);
	const draggingRef = (0, import_react.useRef)(false);
	const settleTimer = (0, import_react.useRef)(null);
	const lastIdxRef = (0, import_react.useRef)(-1);
	const lastHapticAt = (0, import_react.useRef)(0);
	const height = itemHeight * visible;
	const pad = itemHeight * Math.floor(visible / 2);
	(0, import_react.useEffect)(() => {
		preloadHaptics();
	}, []);
	const tickHaptic = (0, import_react.useCallback)(() => {
		const now = Date.now();
		if (now - lastHapticAt.current < 28) return;
		lastHapticAt.current = now;
		hapticSnap();
	}, []);
	const indexOfValue = (0, import_react.useCallback)((v) => {
		const i = options.findIndex((o) => o.value === v);
		return i >= 0 ? i : 0;
	}, [options]);
	const snapToIndex = (0, import_react.useCallback)((idx, behavior = "smooth", withHaptic = true) => {
	...
	const nearestIndex = (0, import_react.useCallback)(() => {
		const el = scrollerRef.current;
		if (!el) return 0;
		return Math.max(0, Math.min(options.length - 1, Math.round(el.scrollTop / itemHeight)));
	}, [itemHeight, options.length]);
	const settle = (0, import_react.useCallback)(() => {
	...
	(0, import_react.useEffect)(() => {
		...
		if (Math.abs(el.scrollTop - top) > 1) el.scrollTo({
			top,
			behavior: "auto"
		});
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: cn("relative overflow-hidden rounded-[var(--radius-md)] border border-white/20 bg-black/40 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.04)]", className),
		style: { height },
		"data-no-swipe": true,
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				tabIndex: 0,
				className: cn("h-full overflow-y-auto overscroll-contain", "snap-y snap-mandatory", "[-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"),
				style: {
					paddingTop: pad,
					paddingBottom: pad,
				...
				children: options.map((o, i) => {
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						className: cn("flex w-full snap-center snap-always flex-col items-center justify-center px-1.5 text-center transition-colors duration-150", selected ? "text-white" : "text-white/40"),
						style: {
							height: itemHeight,
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: cn("max-w-full truncate px-0.5 text-[11px] font-bold leading-tight tabular-nums sm:text-[13px]", selected && "text-gold-bright drop-shadow-[0_0_6px_rgba(201,162,39,0.35)]"),
							children: o.label
						}), o.sublabel ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "max-w-full truncate text-[8px] font-semibold tabular-nums text-white/65 sm:text-[9px]",
							children: o.sublabel
						}) : null]
					}, `${String(o.value)}-${i}`);
				})
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								children: loanEntryMode === "roll" ? "QUICK LOAN · SWIPE TO ROLL" : "QUICK LOAN · MANUAL ENTRY"
								...
								"aria-label": loanEntryMode === "roll" ? "Switch to manual entry" : "Switch to roll pickers",
								title: loanEntryMode === "roll" ? "Manual entry" : "Swipe rollers",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SlidersHorizontal, { className: "size-3.5" }), loanEntryMode === "manual" ? "Rollers" : "Manual"]
							})]
						}),
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										...
										children: "CREDIT"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RollPicker, {
