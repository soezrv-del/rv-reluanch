//#region node_modules/.nitro/vite/services/ssr/assets/catalog-cr78mWmG.js
var RV_DATA = {
	Newmar: {
		Essex: {
			type: "Class A Diesel",
			...
			lengthRange: [45, 45],
			weightRange: [54e3, 62e3],
			slideouts: 5,
			sleeps: 4,
			msrpRange: [899e3, 135e4],
		...
		"Dutch Star": {
			...
			lengthRange: [37, 45],
			weightRange: [36e3, 48e3],
			slideouts: 3,
			sleeps: 6,
			msrpRange: [349e3, 549e3],
			engine: "Cummins L9 450HP",
			horsepower: 450,
			torqueLbFt: 1250,
		...
		"New Aire": {
			...
			warrantyYears: 2,
			yearStart: 2014,
			description: "Newmar New Aire — compact luxury diesel. Early years: Cummins B6.7 / ISB 360 HP / 800 lb-ft. Later years moved to Cummins L-series ~450 HP / 1,250 on Freightliner or Spartan. Year-band required — never force B6.7 on a modern L9 coach.",
			powertrainByYear: [
				{
					from: 2014,
					to: 2018,
				...
				},
				{
					...
					chassis: "Freightliner / Spartan K2 (by option)",
					transmission: "Allison 3000 MH",
					notes: "Recent New Aire OEM marketing: L diesel ~450 HP / 1,250 — not B6.7 360"
				}
			]
		},
		Ventana: {
			...
			lengthRange: [34, 44],
			weightRange: [3e4, 45600],
			slideouts: 3,
			sleeps: 6,
			msrpRange: [279e3, 489e3],
			...
			powertrainByYear: [
				...
				},
				{
					from: 2010,
					to: 2015,
					engine: "Cummins ISB / ISL diesel (era)",
					horsepower: 360,
					torqueLbFt: 800,
					chassis: "Freightliner XC-Series",
					transmission: "Allison 3000 MH"
				},
				{
					from: 2016,
					to: 2019,
					engine: "Cummins B6.7 360HP (longer plans may differ)",
					horsepower: 360,
					torqueLbFt: 800,
					chassis: "Freightliner XC / Spartan (by option)",
					transmission: "Allison 3000 MH"
				},
				{
					from: 2020,
				...
				},
				{
					...
					fuelCapacityGal: 100,
					towingCapacity: 15e3,
					notes: "40–43 L9 400/1250 including 4369"
				},
				{
					from: 2020,
					to: 2026,
				...
				},
				{
					...
					horsepower: 400,
					torqueLbFt: 1250,
					chassis: "Freightliner Custom / Spartan K2 Tag",
					transmission: "Allison 3000 MH"
				}
			]
		},
		"Ventana LE": {
			...
			slideouts: 3,
			sleeps: 6,
			msrpRange: [189e3, 289e3],
			engine: "Cummins ISB 6.7L 340–360HP (by length)",
			horsepower: 340,
			torqueLbFt: 800,
			chassis: "Freightliner XCR (no tag on most LE)",
			transmission: "Allison 3000 MH",
			fuelType: "Diesel",
			recalls: 0,
			rating: 4.35,
		...
		"Grand Star": {
			...
			blackWater: 50,
			fuelCapacityGal: 100,
			generator: "Onan 8,000W Quiet Diesel",
			awningLength: 16,
			ceilingHeight: 84,
			founded: 1968,
			warrantyYears: 2,
		...
		"Super Star": {
			...
			lengthRange: [37, 41],
			weightRange: [3e4, 38e3],
			slideouts: 3,
			sleeps: 8,
			msrpRange: [499e3, 62e4],
			engine: "Cummins 360HP (M2-106) or 450HP (M2-112)",
			horsepower: 360,
			torqueLbFt: 1150,
			chassis: "Freightliner M2-106 / M2-112 (by length)",
		...
		"Supreme Aire": {
			...
			lengthRange: [38, 45],
			weightRange: [36e3, 52e3],
			slideouts: 4,
			sleeps: 6,
			msrpRange: [66e4, 89e4],
			engine: "Detroit DD13 525HP or DD16 600HP (by length)",
			horsepower: 525,
			torqueLbFt: 1850,
			chassis: "Freightliner Cascadia (single or tandem)",
			...
			powertrainByYear: [
				{
					...
					horsepower: 525,
					torqueLbFt: 1850,
					chassis: "Freightliner Cascadia single axle",
					towingCapacity: 2e4
				},
				{
					from: 2026,
					...
					horsepower: 600,
					torqueLbFt: 1850,
					chassis: "Freightliner Cascadia tandem axle",
					towingCapacity: 3e4
				},
				{
					from: 2026,
		...
		"Freedom Aire": {
			...
			lengthRange: [25, 25],
			weightRange: [11e3, 12500],
			slideouts: 1,
			sleeps: 4,
			msrpRange: [289e3, 36e4],
		...
		"Bay Star": {
			...
			lengthRange: [30, 38],
			weightRange: [16e3, 24e3],
			slideouts: 2,
			sleeps: 6,
			msrpRange: [169e3, 269e3],
		...
		"Bay Star Sport": {
			...
			lengthRange: [27, 33],
			weightRange: [14e3, 2e4],
			slideouts: 2,
			sleeps: 6,
			msrpRange: [149e3, 229e3],
	...
	Tiffin: {
		...
		"Allegro 45OPP": {
			...
			lengthRange: [45, 45],
			weightRange: [46e3, 56e3],
			slideouts: 4,
			sleeps: 4,
			msrpRange: [389900, 72e4],
			engine: "Cummins L9 450HP (X12 optional)",
			horsepower: 450,
			torqueLbFt: 1250,
			chassis: "Tiffin PowerGlide",
			...
			warrantyYears: 2,
			yearStart: 2009,
			description: "Tiffin Allegro Bus 45OPP — 45-ft outdoor patio package with pass-through outdoor kitchen, full-wall slide, and king master. Same PowerGlide L9 platform as Allegro Bus; this alias matches the 8/28 ezrv search name.",
			powertrainByYear: [{
				from: 2009,
				to: 2015,
				engine: "Cummins ISL / ISB 300–450HP (era)",
		...
		Phaeton: {
			...
			warrantyYears: 2,
			yearStart: 2e3,
			description: "Tiffin Phaeton — Class A diesel. OEM: Cummins L9 380 HP / 1,150 lb-ft standard. 450 HP / 1,250 was NOT on every floorplan (e.g. not 37BH). Powertrain is floorplan-specific — use selected plan. Freightliner S / PowerGlide O. Allison 3000 MH.",
			powertrainByYear: [
				{
					from: 2005,
					to: 2009,
				...
				},
				{
					...
					towingCapacity: 1e4,
					generator: "Onan 10.0 kW diesel (slide-out)",
					notes: "37BH only — brochure 380/1150. 450 HP was NOT an option on 37BH."
				},
				{
					from: 2016,
					to: 2026,
					...
					towingCapacity: 1e4,
					generator: "Onan 10.0 kW diesel (slide-out)",
					notes: "44OH tag axle — 380 standard; 450/1250 may be available. Confirm build sheet."
				},
				{
					from: 2016,
					to: 2018,
					...
					notes: "Default L9 380/1150. 450 only on select floorplans (not 37BH) — requires floorplan match."
				},
				{
					from: 2019,
					to: 2026,
					...
					blackWater: 50,
					ceilingHeight: 83,
					notes: "Default L9 380/1150 by floorplan. 450 only where brochure offered it (e.g. some tag-axle) — never invent 450 for 37BH."
				}
			]
		},
		"Allegro Red 340": {
		...
		"Open Road": {
			...
			lengthRange: [32, 36],
			weightRange: [16e3, 22e3],
			slideouts: 2,
			sleeps: 6,
			msrpRange: [159e3, 249e3],
		...
		Wayfarer: {
			...
			lengthRange: [24, 26],
			weightRange: [1e4, 12e3],
			slideouts: 0,
			sleeps: 4,
			msrpRange: [149e3, 219e3],
		...
		Cahaba: {
			...
			lengthRange: [19, 22],
			weightRange: [9e3, 11e3],
			slideouts: 0,
			sleeps: 2,
			msrpRange: [169e3, 229e3],
	...
	Thor: {
		...
		Vegas: {
			...
			warrantyYears: 1,
			yearStart: 2014,
			description: "Thor Vegas — compact Class A RUV (European-style Class A body on Ford cutaway chassis, not F53). Sister to Axis. OEM recent: Ford 7.3L V8 ~325 HP / 450 lb-ft, 55 gal fuel, hitch 8,000 lb. Floorplans 24.1 (~25' 8\"), 26.1/26.2 (~27' 2\"), 28.1 (~30' 6\"). GVWR ~12,500–14,500. Confirm year: early units Triton V10.",
			powertrainByYear: [{
				from: 2014,
				to: 2019,
				engine: "Ford Triton V10 6.8L",
				...
				fuelCapacityGal: 55,
				towingCapacity: 8e3,
				notes: "Thor OEM: 7.3L V8 325 HP / 450 lb-ft · gas · hitch 8,000 · not F53 Class A chassis"
			}]
		},
		Axis: {
			type: "Class A Gas",
			...
			warrantyYears: 1,
			yearStart: 2014,
			description: "Thor Axis — compact Class A RUV sister to Vegas (same Ford cutaway platform / floorplan family; trim & décor differ). Not traditional F53 Class A. Recent OEM: Ford 7.3L V8 ~325 HP / 450 lb-ft, 55 gal, hitch 8,000 lb. Plans 24.1 / 26.1 / 26.2 / 28.1.",
			powertrainByYear: [{
				from: 2014,
				to: 2019,
				engine: "Ford Triton V10 6.8L",
				...
				fuelCapacityGal: 55,
				towingCapacity: 8e3,
				notes: "Sister to Vegas — same 7.3L 325/450 package; confirm décor/options vs Vegas"
			}]
		},
		Sereno: {
			type: "Class A Diesel",
			...
			yearStart: 2010,
			yearEnd: 2016,
			description: "Thor Sereno — front-engine diesel Class A (2010–2016). Navistar MaxxForce 7 ~300 HP on Thor FED chassis. Lower entry / car-like drive vs rear pusher; not Palazzo/Tuscany.",
			powertrainByYear: [{
				from: 2010,
				to: 2016,
		...
		Hurricane: {
			...
			yearStart: 2e3,
			yearEnd: 2020,
			description: "Thor Hurricane — gas Class A on Ford F53 (2000–2020). Family dual-slide layouts; V10 then 7.3 Godzilla. Discontinued after 2020 as Thor consolidated around ACE / Windsport / Challenger.",
			powertrainByYear: [{
				from: 2e3,
				to: 2019,
				engine: "Ford Triton V10 6.8L",
		...
		"Four Winds Majestic": {
			...
			yearStart: 2e3,
			yearEnd: 2014,
			description: "Thor Four Winds Majestic — budget Class C on Ford E-450 (through ~2014). Over-cab bunk layouts; later folded into Four Winds / Chateau.",
			powertrainByYear: [{
				from: 2e3,
				to: 2014,
				engine: "Ford 6.8L V10 / 6.2L V8 (by year)",
		...
		Mandalay: {
			...
			yearStart: 2001,
			yearEnd: 2008,
			description: "Mandalay — Thor-owned luxury diesel pusher from Coburg, Oregon (2001–2008). Spartan K2 + Cummins ISL/ISX. Above Tuscany; brand ended in 2008.",
			powertrainByYear: [{
				from: 2001,
				to: 2008,
				engine: "Cummins ISL ~380HP / ISX ~500HP (by trim)",
		...
		Windsport: {
			...
			lengthRange: [27, 35],
			weightRange: [15e3, 22e3],
			slideouts: 2,
			sleeps: 8,
			msrpRange: [139e3, 209e3],
			engine: "Ford 7.3L / V10 (by year)",
			horsepower: 350,
			chassis: "Ford F53",
			fuelType: "Gas",
		...
		Seneca: {
			...
			lengthRange: [37, 38],
			weightRange: [24e3, 32e3],
			slideouts: 2,
			sleeps: 6,
			msrpRange: [229e3, 349e3],
		...
		Geneva: {
			...
			lengthRange: [25, 30],
			weightRange: [11e3, 14500],
			slideouts: 1,
			sleeps: 6,
			msrpRange: [99e3, 159e3],
		...
		Sequence: {
			...
			lengthRange: [20, 23],
			weightRange: [8500, 11e3],
			slideouts: 0,
			sleeps: 2,
			msrpRange: [145e3, 195e3],
	...
	Coachmen: {
		...
		"Freedom Express": {
			...
			lengthRange: [20, 36],
			weightRange: [3800, 7800],
			slideouts: 1,
			sleeps: 8,
			msrpRange: [27900, 52e3],
			chassis: "N/A (towable)",
			fuelType: "N/A (towable)",
			recalls: 0,
			rating: 4.25,
		...
		Galleria: {
			...
			lengthRange: [24, 25],
			weightRange: [10500, 12e3],
			slideouts: 0,
			sleeps: 4,
			msrpRange: [129900, 189e3],
		...
		Adrenaline: {
			...
			lengthRange: [26, 36],
			weightRange: [6e3, 11e3],
			slideouts: 1,
			sleeps: 8,
			msrpRange: [39900, 74900],
			chassis: "N/A (towable)",
			fuelType: "N/A (towable)",
			recalls: 0,
			rating: 4.2,
		...
		Concord: {
			...
			lengthRange: [28, 33],
			weightRange: [13e3, 15500],
			slideouts: 2,
			sleeps: 7,
			msrpRange: [109900, 164e3],
			engine: "Ford 7.3L V8",
			horsepower: 350,
			chassis: "Ford E-450",
			fuelType: "Gas",
		...
		"Leprechaun Premier": {
			...
			lengthRange: [26, 32],
			weightRange: [12500, 15e3],
			slideouts: 2,
			sleeps: 7,
			msrpRange: [114900, 169e3],
			engine: "Ford 7.3L V8",
			horsepower: 350,
			powertrainByYear: [{
				from: 2016,
	...
	Winnebago: {
		Forza: {
			...
			lengthRange: [34, 39],
			weightRange: [28e3, 34e3],
			slideouts: 3,
			sleeps: 6,
			msrpRange: [299e3, 389e3],
		...
		Boldt: {
			...
			lengthRange: [22, 23],
			weightRange: [9e3, 10500],
			slideouts: 0,
			sleeps: 2,
			msrpRange: [179e3, 219e3],
			engine: "Mercedes-Benz 2.0L I4 turbodiesel",
			horsepower: 208,
			powertrainByYear: [{
				from: 2020,
		...
		View: {
			...
			lengthRange: [24, 26],
			weightRange: [1e4, 12500],
			slideouts: 0,
			sleeps: 4,
			msrpRange: [179e3, 239e3],
			engine: "Mercedes-Benz 2.0L I4 turbodiesel",
			horsepower: 208,
			chassis: "Mercedes-Benz Sprinter",
			fuelType: "Diesel",
		...
		"Access Super C": {
			...
			lengthRange: [26, 33],
			weightRange: [2e4, 28e3],
			slideouts: 2,
			sleeps: 6,
			msrpRange: [219e3, 319e3],
			engine: "Ford Power Stroke 6.7L Diesel",
			horsepower: 330,
			powertrainByYear: [{
				from: 2021,
		...
		"Micro Minnie": {
			...
			lengthRange: [17, 26],
			weightRange: [3e3, 6500],
			slideouts: 0,
			sleeps: 6,
			msrpRange: [24900, 48e3],
			chassis: "N/A (towable)",
			fuelType: "N/A (towable)",
			recalls: 0,
			rating: 4.5,
	...
	"Forest River": {
		...
		Sunseeker: {
			...
			lengthRange: [27, 33],
			weightRange: [12e3, 14500],
			slideouts: 2,
			sleeps: 8,
			msrpRange: [99e3, 175e3],
			engine: "Ford 7.3L V8 gas 325HP (E-450)",
			horsepower: 325,
			torqueLbFt: 450,
			chassis: "Ford E-450",
			...
			blackWater: 39,
			fuelCapacityGal: 55,
			generator: "Onan / Generac 4kW gas",
			awningLength: 16,
			ceilingHeight: 80,
			founded: 1996,
			warrantyYears: 1,
			...
			powertrainByYear: [
				...
				},
				{
					...
					towingCapacity: 7500,
					gvwrLbs: 14500,
					notes: "E-450 7.3 325/450 — not 350 invent"
				}
			]
		},
		"Sunseeker LE": {
			...
			lengthRange: [20, 33],
			weightRange: [10500, 14500],
			slideouts: 1,
			sleeps: 6,
			msrpRange: [75e3, 145e3],
			engine: "Ford 7.3L V8 325HP or Chevy 6.6L V8 gas (by chassis)",
			horsepower: 325,
			torqueLbFt: 450,
			chassis: "Ford E-350 / E-450 or Chevy 3500",
			...
			powertrainByYear: [
				{
					from: 2012,
					to: 2019,
					engine: "Ford 6.2L / 6.8L gas (by year)",
					horsepower: 305,
					chassis: "Ford E-350 / E-450"
				},
				{
					...
					engine: "Ford 7.3L V8 325HP or Chevy 6.6L V8 gas",
					horsepower: 325,
					torqueLbFt: 450,
					chassis: "Ford E-350 / Chevy 3500",
					towingCapacity: 5e3
				},
				{
					from: 2020,
		...
		"Sunseeker 4X4": {
			...
			lengthRange: [24, 25],
			weightRange: [13e3, 14500],
			slideouts: 0,
			sleeps: 5,
			msrpRange: [13e4, 185e3],
			engine: "Ford 7.3L V8 gas 325HP",
			horsepower: 325,
			torqueLbFt: 450,
			chassis: "Ford E-450 4WD (4-inch lift)",
			transmission: "6-speed TorqShift",
			fuelType: "Gas",
			recalls: 0,
			rating: 4.3,
		...
		"Sunseeker MBS": {
			...
			lengthRange: [25, 26],
			weightRange: [9500, 11030],
			slideouts: 1,
			sleeps: 4,
			msrpRange: [165e3, 23e4],
			engine: "Mercedes-Benz 2.0L turbo diesel 208HP",
			horsepower: 208,
			torqueLbFt: 332,
			chassis: "Mercedes-Benz Sprinter",
		...
		"Sunseeker PM": {
			...
			lengthRange: [23, 24],
			weightRange: [8e3, 9350],
			slideouts: 0,
			sleeps: 3,
			msrpRange: [115e3, 165e3],
			engine: "Ram 3.6L V6 Pentastar gas",
			horsepower: 276,
			torqueLbFt: 250,
			chassis: "Ram ProMaster",
			transmission: "9-speed automatic",
		...
		"Rockwood Mini Lite": {
			...
			lengthRange: [21, 29],
			weightRange: [4200, 6200],
			slideouts: 1,
			sleeps: 6,
			msrpRange: [32900, 52e3],
			chassis: "N/A (towable)",
			fuelType: "N/A (towable)",
			recalls: 0,
			rating: 4.45,
		...
		"Flagstaff Micro Lite": {
			...
			lengthRange: [21, 29],
			weightRange: [4200, 6500],
			slideouts: 1,
			sleeps: 6,
			msrpRange: [33900, 54e3],
			chassis: "N/A (towable)",
			fuelType: "N/A (towable)",
			recalls: 0,
			rating: 4.45,
		...
		"Salem Cruise Lite": {
			...
			lengthRange: [21, 34],
			weightRange: [3800, 7500],
			slideouts: 1,
			sleeps: 8,
			msrpRange: [22900, 48e3],
			chassis: "N/A (towable)",
			fuelType: "N/A (towable)",
			recalls: 0,
			rating: 4.15,
		...
		"Salem Hemisphere": {
			...
			lengthRange: [29, 38],
			weightRange: [6500, 9500],
			slideouts: 2,
			sleeps: 8,
			msrpRange: [39900, 72e3],
			chassis: "N/A (towable)",
			fuelType: "N/A (towable)",
			recalls: 0,
			rating: 4.25,
		...
		Wildwood: {
			...
			lengthRange: [24, 38],
			weightRange: [5e3, 9500],
			slideouts: 2,
			sleeps: 10,
			msrpRange: [24900, 58e3],
			chassis: "N/A (towable)",
			fuelType: "N/A (towable)",
			recalls: 0,
			rating: 4.15,
		...
		"r-Pod": {
			...
			lengthRange: [16, 25],
			weightRange: [2400, 4200],
			slideouts: 0,
			sleeps: 4,
			msrpRange: [19900, 38e3],
			chassis: "N/A (towable)",
			fuelType: "N/A (towable)",
			recalls: 0,
			rating: 4.3,
	...
	Airstream: {
		...
		"Basecamp Xe": {
			...
			lengthRange: [20, 21],
			weightRange: [3200, 4e3],
			slideouts: 0,
			sleeps: 4,
			msrpRange: [88900, 98e3],
			chassis: "N/A (towable)",
			fuelType: "N/A (towable)",
			recalls: 0,
			rating: 4.6,
		...
		Globetrotter: {
			...
			floorplans: [
				...
				"30RB",
				"25FB Dublin Slate",
				"25FB Copenhagen Cream",
				"25FB London Grey",
				"25FB Barcelona Blue",
				"27FB Dublin Slate",
				"27FB Copenhagen Cream",
				"27FB London Grey",
				"27FB Barcelona Blue",
				"30RB Dublin Slate",
				"30RB Copenhagen Cream"
			],
			floorplansByYear: {
				"2016": [
					"23FB",
		...
		Classic: {
			...
			lengthRange: [28, 33],
			weightRange: [7500, 9e3],
			slideouts: 0,
			sleeps: 5,
			msrpRange: [175e3, 245e3],
			chassis: "N/A (towable)",
			fuelType: "N/A (towable)",
			recalls: 0,
			rating: 4.9,
		...
		"Frank Lloyd Wright Usonian": {
			...
			lengthRange: [28, 28],
			weightRange: [6800, 8e3],
			slideouts: 0,
			sleeps: 4,
			msrpRange: [189900, 21e4],
			chassis: "N/A (towable)",
			fuelType: "N/A (towable)",
			recalls: 0,
			rating: 4.75,
			...
			powertrainByYear: [
				{
					from: 2005,
					to: 2009,
					engine: "Mercedes-Benz turbodiesel (Sprinter T1N / early NCV3)",
					horsepower: 154,
					chassis: "Mercedes-Benz Sprinter",
					notes: "Early Interstate — ~154–188 HP by year"
				},
				{
					from: 2010,
					to: 2018,
					engine: "Mercedes-Benz 3.0L V6 turbodiesel (OM642)",
					horsepower: 188,
					torqueLbFt: 325,
					chassis: "Mercedes-Benz Sprinter",
					notes: "NCV3 Sprinter era"
				},
				{
					from: 2019,
					to: 2023,
					engine: "Mercedes-Benz 3.0L I6 turbodiesel (OM642 / VS30)",
					horsepower: 188,
					torqueLbFt: 325,
				...
				},
				{
					from: 2024,
					to: 2027,
					engine: "Mercedes-Benz 2.0L twin-turbo I4 diesel",
					horsepower: 208,
					torqueLbFt: 332,
					chassis: "Mercedes-Benz Sprinter",
					notes: "Advanced Power System standard on GT/GL from 2026. X = adventure; XE/GTX = adventure + luxury"
				}
			],
		...
		"Tommy Bahama": {
			...
			lengthRange: [19, 25],
			weightRange: [9e3, 12500],
			slideouts: 0,
			sleeps: 2,
			msrpRange: [255e3, 36e4],
			engine: "Mercedes-Benz 2.0L twin-turbo I4 diesel (Sprinter)",
			horsepower: 208,
			torqueLbFt: 332,
			chassis: "Mercedes-Benz Sprinter",
			...
			powertrainByYear: [
				...
				},
				{
					from: 2019,
					to: 2023,
					engine: "Mercedes-Benz 3.0L I6 turbodiesel",
					horsepower: 188,
					chassis: "Mercedes-Benz Sprinter"
				},
				{
					...
					horsepower: 208,
					torqueLbFt: 332,
					chassis: "Mercedes-Benz Sprinter 4500 (Atlas) / Sprinter (Interstate)",
					notes: "Resort interior: woven textiles, warm wood, rattan, island-inspired fabrics. Not a layout — a trim on Interstate 19GT/24GL/24GT and Atlas 25MS."
				}
			],
		...
		Atlas: {
			...
			powertrainByYear: [
				...
				},
				{
					...
					torqueLbFt: 332,
					chassis: "Mercedes-Benz Sprinter 4500",
					notes: "25MS = Master Suite flagship; 25RT = rear garage / pass-through. Tommy Bahama on 25MS."
				}
			],
		...
		Rangeline: {
			...
			powertrainByYear: [{
				...
				torqueLbFt: 250,
				chassis: "RAM ProMaster 3500",
				notes: "Gas ProMaster — not a Mercedes diesel. 21PL = Premier Loft (sleeps 4); 21PS = Premier Studio."
			}],
	...
	Keystone: {
		...
		"Montana High Country": {
			...
			lengthRange: [29, 41],
			weightRange: [9e3, 14500],
			slideouts: 3,
			sleeps: 8,
			msrpRange: [69900, 139e3],
			chassis: "N/A (towable)",
			fuelType: "N/A (towable)",
			recalls: 0,
			rating: 4.5,
		...
		Cougar: {
			...
			lengthRange: [22, 35],
			weightRange: [5500, 1e4],
			slideouts: 2,
			sleeps: 8,
			msrpRange: [34900, 72e3],
			chassis: "N/A (towable)",
			fuelType: "N/A (towable)",
			recalls: 0,
			rating: 4.35,
		...
		"Cougar 5th Wheel": {
			...
			lengthRange: [30, 39],
			weightRange: [9500, 14e3],
			slideouts: 3,
			sleeps: 8,
			msrpRange: [49900, 95e3],
			chassis: "N/A (towable)",
			fuelType: "N/A (towable)",
			recalls: 0,
			rating: 4.4,
		...
		"Cougar Half-Ton": {
			...
			lengthRange: [27, 35],
			weightRange: [7500, 10500],
			slideouts: 2,
			sleeps: 6,
			msrpRange: [39900, 79e3],
		...
		Bullet: {
			...
			lengthRange: [18, 36],
			weightRange: [3200, 7800],
			slideouts: 1,
			sleeps: 8,
			msrpRange: [22900, 52e3],
			chassis: "N/A (towable)",
			fuelType: "N/A (towable)",
			recalls: 0,
			rating: 4.25,
		...
		Springdale: {
			...
			lengthRange: [18, 34],
			weightRange: [3e3, 7500],
			slideouts: 1,
			sleeps: 8,
			msrpRange: [18900, 48e3],
			chassis: "N/A (towable)",
			fuelType: "N/A (towable)",
			recalls: 0,
			rating: 4.15,
		...
		Avalanche: {
			...
			lengthRange: [30, 40],
			weightRange: [10500, 15e3],
			slideouts: 3,
			sleeps: 8,
			msrpRange: [64900, 115e3],
			chassis: "N/A (towable)",
			fuelType: "N/A (towable)",
			recalls: 0,
			rating: 4.3,
			...
			powertrainByYear: [
				{
					...
					horsepower: 330,
					torqueLbFt: 950,
					chassis: "Ford F-600 Super Duty 4x4",
					towingCapacity: 15e3,
					gvwrLbs: 22e3
				},
				{
					...
					horsepower: 330,
					torqueLbFt: 950,
					chassis: "Ford F-550 Super Duty 4x4",
					towingCapacity: 1e4,
					gvwrLbs: 19500
				},
				{
					...
					horsepower: 330,
					torqueLbFt: 950,
					chassis: "Ford Super Duty 4x4 (F-600 / F-550)"
				}
			]
		},
		"Lineage Series VT": {
	...
	Fleetwood: {
		...
		"Discovery LXE": {
			...
			lengthRange: [40, 44],
			weightRange: [38e3, 48e3],
			slideouts: 4,
			sleeps: 6,
			msrpRange: [349e3, 529e3],
	...
	Jayco: {
		...
		Seneca: {
			...
			yearStart: 2014,
			yearEnd: 2027,
			description: "Jayco Seneca Super C — Freightliner S2RV Plus, Cummins ISB 6.7 360/800. Current layouts 37K (bath-and-a-half, sleeps 6), 37L (bunks, sleeps 9), 37M (opposing slides, sleeps 8). All ~39' 4\". Sister to Entegra Accolade.",
			powertrainByYear: [{
				from: 2014,
				to: 2017,
				...
				notes: "Jayco OEM: S2RV Plus · ISB 6.7 360 hp / 800 lb-ft · Allison 3000 MH · 100 gal · 12k hitch. Not a diesel pusher L9."
			}]
		},
		"Seneca Super C": {
			type: "Super C",
			...
			yearStart: 2014,
			yearEnd: 2027,
			description: "Jayco Seneca Super C — same as Seneca. Current 37K / 37L / 37M.",
			powertrainByYear: [{
				from: 2018,
				to: 2027,
				engine: "Cummins ISB 6.7L 360HP",
	...
	"American Coach": {
		...
		"American Dream": {
			...
			lengthRange: [42, 45],
			weightRange: [48e3, 58e3],
			slideouts: 4,
			sleeps: 6,
			msrpRange: [549e3, 899e3],
			engine: "Cummins L9 / X15 (by option)",
			horsepower: 450,
			torqueLbFt: 1250,
	...
	"Entegra Coach": {
		...
		"Reatta XL": {
			...
			lengthRange: [37, 39],
			weightRange: [3e4, 39e3],
			slideouts: 2,
			sleeps: 6,
			msrpRange: [309e3, 479e3],
			engine: "Cummins B6.7 360HP",
			horsepower: 360,
			torqueLbFt: 800,
			chassis: "Spartan K1",
		...
		"Vision XL": {
			...
			lengthRange: [29, 36],
			weightRange: [16e3, 23e3],
			slideouts: 2,
			sleeps: 6,
			msrpRange: [169e3, 279e3],
			engine: "Ford 7.3L V8 Godzilla",
			horsepower: 350,
			chassis: "Ford F53",
			fuelType: "Gas",
		...
		"Accolade XL": {
			...
			lengthRange: [37, 38],
			weightRange: [27e3, 35e3],
			slideouts: 2,
			sleeps: 6,
			msrpRange: [279e3, 429e3],
		...
		Centurion: {
			...
			horsepower: 525,
			torqueLbFt: 1850,
			chassis: "Freightliner Cascadia 116 Day Cab / Cascadia 126 (45D)",
			...
			blackWater: 40,
			fuelCapacityGal: 120,
			generator: "Onan 8,000W diesel + auto-gen start",
			awningLength: 20,
			ceilingHeight: 84,
			founded: 2008,
			warrantyYears: 2,
			...
			powertrainByYear: [
				...
				},
				{
					from: 2026,
					to: 2027,
					engine: "Detroit DD13 GEN 5 12.8L 525HP (39N/39K) or DD16 600HP (45D)",
					horsepower: 525,
					torqueLbFt: 1850,
					chassis: "Freightliner Cascadia"
				}
		...
		Expanse: {
			...
			warrantyYears: 3,
			yearStart: 2020,
			description: "Entegra Expanse — Super C on Ford F-550 with 6.7L Power Stroke. Compact Super C (26–35 ft) with bunkhouse and toy-hauler plans; not a Transit van conversion.",
			powertrainByYear: [{
				from: 2020,
				to: 2026,
				engine: "Ford 6.7L Power Stroke Diesel",
		...
		Odyssey: {
			...
			warrantyYears: 3,
			yearStart: 2018,
			description: "Entegra Odyssey — entry Class C on Ford E-450. Bunkhouse layouts and Entegra's 3-year structural warranty at a Thor Four Winds / Coachmen Freelander price.",
			powertrainByYear: [{
				from: 2018,
				to: 2019,
	...
	Heartland: {
		Bighorn: {
			...
			lengthRange: [32, 42],
			weightRange: [12e3, 19e3],
			slideouts: 4,
			sleeps: 8,
			msrpRange: [79900, 145e3],
			chassis: "N/A (towable)",
			fuelType: "N/A (towable)",
			recalls: 0,
			rating: 4.45,
	...
	"Pleasure-Way": {
		...
		"Plateau TS": {
			...
			lengthRange: [22, 24],
			weightRange: [1e4, 11500],
			slideouts: 0,
			sleeps: 4,
			msrpRange: [155e3, 23e4],
			engine: "Mercedes-Benz diesel (Sprinter)",
			horsepower: 188,
			chassis: "Mercedes Sprinter",
			fuelType: "Diesel",
		...
		"Ontour 2.0": {
			...
			lengthRange: [19, 20],
			weightRange: [7800, 9e3],
			slideouts: 0,
			sleeps: 2,
			msrpRange: [115e3, 195e3],
			engine: "Ford Transit 3.5L EcoBoost",
			horsepower: 310,
			powertrainByYear: [{
				from: 2016,
	...
	Roadtrek: {
		...
		"Zion Slumber": {
			...
			lengthRange: [19, 20],
			weightRange: [7200, 8500],
			slideouts: 0,
			sleeps: 2,
			msrpRange: [85e3, 125e3],
			engine: "Ram 3.6L V6 gas",
			horsepower: 280,
			chassis: "Ram ProMaster",
			fuelType: "Gas",
		...
		Play: {
			...
			lengthRange: [19, 21],
			weightRange: [7500, 9500],
			slideouts: 0,
			sleeps: 4,
			msrpRange: [95e3, 155e3],
			engine: "Ram 3.6L V6 gas",
			horsepower: 280,
			powertrainByYear: [{
				from: 2018,
	...
	Palomino: {
		Puma: {
			...
			lengthRange: [18, 40],
			weightRange: [3200, 9e3],
			slideouts: 1,
			sleeps: 10,
			msrpRange: [21900, 52e3],
			chassis: "N/A (towable)",
			fuelType: "N/A (towable)",
			recalls: 0,
			rating: 4.15,
		...
		SolAire: {
			...
			lengthRange: [22, 35],
			weightRange: [4500, 7800],
			slideouts: 1,
			sleeps: 8,
			msrpRange: [28900, 48e3],
			chassis: "N/A (towable)",
			fuelType: "N/A (towable)",
			recalls: 0,
			rating: 4.2,
		...
		"Real-Lite": {
			...
			lengthRange: [16, 24],
			weightRange: [2500, 4500],
			slideouts: 0,
			sleeps: 6,
			msrpRange: [16900, 36e3],
			chassis: "N/A (towable)",
			fuelType: "N/A (towable)",
			recalls: 0,
			rating: 4.15,
	...
	Dutchmen: {
		...
		Coleman: {
			...
			lengthRange: [18, 35],
			weightRange: [3e3, 8500],
			slideouts: 1,
			sleeps: 10,
			msrpRange: [18900, 45e3],
			chassis: "N/A (towable)",
			fuelType: "N/A (towable)",
			recalls: 0,
			rating: 4.1,
		...
		"Voltage V-Series": {
			...
			lengthRange: [28, 40],
			weightRange: [9e3, 15e3],
			slideouts: 2,
			sleeps: 8,
			msrpRange: [54900, 11e4],
			chassis: "N/A (towable)",
			fuelType: "N/A (towable)",
			recalls: 0,
			rating: 4.25,
	...
	"Leisure Travel Vans": {
		...
		"Wonder XL": {
			...
			lengthRange: [25, 27],
			weightRange: [12e3, 15500],
			slideouts: 1,
			sleeps: 4,
			msrpRange: [19e4, 275e3],
	...
	"Storyteller Overland": {
		...
		"Classic MODE": {
			...
			lengthRange: [19, 22],
			weightRange: [8500, 10500],
			slideouts: 0,
			sleeps: 2,
			msrpRange: [155e3, 22e4],
			engine: "Mercedes-Benz turbodiesel (Sprinter)",
			horsepower: 188,
			powertrainByYear: [{
				from: 2021,
	...
	"Gulf Stream Coach": {
		...
		Yellowstone: {
			...
			lengthRange: [30, 34],
			weightRange: [13500, 16e3],
			slideouts: 2,
			sleeps: 7,
			msrpRange: [99900, 154e3],
			engine: "Ford V8 7.3L",
			horsepower: 350,
			chassis: "Ford E-450",
			fuelType: "Gas",
...
var YEARS = Array.from({ length: 26 }, (_, i) => String(2027 - i));
function getMaintenanceSchedule(rv) {
	...
	if (isClassB) base.push({
		task: "Van Chassis Service (OEM schedule)",
		interval: "Per chassis manual",
		category: "Chassis",
		priority: "Critical"
	});
	return base;
...
function computeRating(make, model, year) {
	const raw = (MANUFACTURER_BASE_SCORES[make] ?? 3.5) + TIER_ADJUSTMENTS[getModelTier(make, model)] + getYearAdjustment(year);
...
function classAFuel(spec) {
	const t = (spec.type || "").toLowerCase();
	const f = (spec.fuelType || "").toLowerCase();
	if (/super\s*c/.test(t)) return null;
	if (!(/class\s*a/.test(t) || /diesel\s*pusher/.test(t) || /gas\s*pusher/.test(t))) return null;
...
function matchesRvClass(spec, classId) {
	if (!classId) return true;
	const t = (spec.type || "").toLowerCase();
	const fuel = classAFuel(spec);
	switch (classId) {
		case "class-a": return fuel !== null;
		case "class-a-diesel": return fuel === "diesel";
		case "class-a-gas": return fuel === "gas";
		case "class-b": return t.includes("class b");
		case "class-c": return t.includes("class c") && !t.includes("super");
		case "super-c": return t.includes("super c");
		case "fifth-wheel": return t.includes("fifth");
		case "travel-trailer": return t.includes("travel trailer");
		case "toy-hauler": return t.includes("toy hauler");
		default: return true;
	}
}
function rvClassLabel(classId) {
	return RV_CLASS_TABS.find((t) => t.id === classId)?.label ?? "All";
}
function compareSelectionKey(r) {
	return `${r.year}|${r.make}|${r.model}|${r.floorplan || ""}`;
}
function isClassTabId(v) {
	if (!v) return false;
	if (v === "class-a") return true;
	return RV_CLASS_TABS.some((t) => t.id === v && t.id !== "");
}
function matchesTypeFilter(spec, filter) {
...
function yearsFromFloorplansByYear(spec) {
	const map = spec.floorplansByYear;
	if (!map) return [];
	return Object.keys(map).map((y) => parseInt(y, 10)).filter((n) => Number.isFinite(n)).sort((a, b) => a - b);
}
/**
...
*/
function modelAvailableInYear(spec, year) {
...
function modelYearWindow(spec) {
	const fbyYears = yearsFromFloorplansByYear(spec);
	if (fbyYears.length > 0) return {
...
*/
function floorplanAvailableInYear(spec, floorplan, year) {
...
*/
function getMakesForYear(year, rvType) {
...
*/
function getModelsForYearMake(year, make, rvType) {
	const y = parseInt(year, 10);
	const hasYear = Boolean(year && Number.isFinite(y));
	if (Boolean(make && RV_DATA[make])) {
		const models = RV_DATA[make];
...
* - Missing model → []
*/
function getFloorplansForYear(year, make, model) {
...
function countModelsForClass(year, classId) {
	if (!year) {
		let n = 0;
		for (const make of MAKES) for (const spec of Object.values(RV_DATA[make] || {})) if (matchesRvClass(spec, classId)) n++;
		return n;
	}
	const y = parseInt(year, 10);
	if (!Number.isFinite(y)) return 0;
	let n = 0;
	for (const make of MAKES) for (const spec of Object.values(RV_DATA[make] || {})) {
...
function getRvTypesForFilters(year, make) {
	const y = parseInt(year, 10);
	const hasYear = Boolean(year && Number.isFinite(y));
	const types = /* @__PURE__ */ new Set();
	const makes = make && RV_DATA[make] ? [make] : hasYear ? getMakesForYear(year) : [...MAKES];
...
*/
function buildCascadeOptions(sel) {
	const year = (sel.year || "").trim();
	const rvType = sel.rvType ?? "";
	const years = [...YEARS];
	const makes = getMakesForYear(year, rvType || void 0);
	const makeCustom = Boolean(sel.make && !makes.includes(sel.make));
	const make = sel.make && (makes.includes(sel.make) || makeCustom) ? sel.make : "";
	const models = make && !makeCustom ? getModelsForYearMake(year, make, rvType || void 0) : !make ? year ? getModelsForYearMake(year, "", rvType || void 0) : getModelsForYearMake("", "", rvType || void 0) : [];
	const modelCustom = Boolean(sel.model && (makeCustom || !models.includes(sel.model)));
	const model = sel.model && (models.includes(sel.model) || modelCustom) ? sel.model : "";
	const floorplans = make && model && !makeCustom && !modelCustom ? getFloorplansForYear(year, make, model) : [];
	const floorplanCustom = Boolean(sel.floorplan && (makeCustom || modelCustom || !floorplans.includes(sel.floorplan)));
	const floorplan = sel.floorplan && (floorplans.includes(sel.floorplan) || floorplanCustom) ? sel.floorplan : "";
	const rvTypes = year && make && !makeCustom ? getRvTypesForFilters(year, make) : year ? getRvTypesForFilters(year) : getRvTypesForFilters("");
	return {
		year,
		make,
		model,
		floorplan,
		rvType: !rvType || isClassTabId(rvType) || rvTypes.includes(rvType) ? rvType : "",
		years,
		makes,
		models,
		floorplans,
...
function applyCascadeChange(current, field, value) {
...
function searchCatalog(sel) {
	...
	if (!map) return [{
		...
		rvType: sel.rvType,
		data: buildCustomSpec(make, sel.model || "Custom model", sel.floorplan || "", sel.rvType),
		custom: true
	}];
	const out = [];
	const modelNames = sel.model ? [sel.model] : getModelsForYearMake(sel.year, make, sel.rvType);
	for (const model of modelNames) {
		...
		if (sel.floorplan) {
			if (!getFloorplansForYear(sel.year, make, model).includes(sel.floorplan)) {
				out.push({
					year: sel.year,
					make,
					model,
	...
	if (out.length === 0 && sel.model) out.push({
		year: sel.year,
		make,
		model: sel.model,
		floorplan: sel.floorplan || "",
...
function estimateMarket(spec, year, floorplan) {
	const y = parseInt(year, 10) || (/* @__PURE__ */ new Date()).getFullYear();
	const age = Math.max(0, (/* @__PURE__ */ new Date()).getFullYear() - y);
	const [msrpLo0, msrpHi0] = spec.msrpRange || [8e4, 2e5];
	let msrpLo = msrpLo0;
	let msrpHi = msrpHi0;
	if (floorplan) {
		...
		if (m) {
			...
			if (ft >= 20 && ft <= 50) {
				...
				msrpLo = Math.max(2e4, Math.round(mid + bias - half));
				msrpHi = Math.round(mid + bias + half);
			}
		}
	}
	if (!msrpLo && !msrpHi) return {
		tradeIn: 0,
		retailLow: 0,
		retailHigh: 0,
		msrpLo: 0,
	...
	const mid = (msrpLo + msrpHi) / 2;
	const retain = Math.max(.38, .92 - age * .045);
	const retailHigh = Math.round(msrpHi * retain / 1e3) * 1e3;
	const retailLow = Math.round(msrpLo * retain * .88 / 1e3) * 1e3;
	const tradeIn = Math.round(mid * retain * .78 / 1e3) * 1e3;
	const segment = /diesel/i.test(spec.fuelType) || /diesel/i.test(spec.type) ? "Diesel motorhome" : /fifth/i.test(spec.type) ? "Fifth wheel" : /trailer/i.test(spec.type) ? "Travel trailer" : /class b/i.test(spec.type) ? "Class B" : "Motorhome";
	return {
		tradeIn,
...
function ratingFor(make, model, year) {
	return computeRating(make, model, year);
}
function modelPickerMeta(make, model, year) {
	...
	const endLabel = end >= 2026 && !spec.yearEnd ? "present" : String(end);
	return `${spec.type} · ${start}–${endLabel} · ${fps.length} FP`;
}
//#endregion
export { rvClassLabel as C, ratingStars as S, getSpec as _, applyCascadeChange as a, modelYearWindow as b, compareSelectionKey as c, formatMoney as d, getFloorplansForYear as f, getRatingMetadata as g, getModelsForYearMake as h, YEARS as i, countModelsForClass as l, getMakesForYear as m, RV_CLASS_TABS as n, buildCascadeOptions as o, getMaintenanceSchedule as p, RV_DATA as r, buildCustomSpec as s, MAKES as t, estimateMarket as u, modelAvailableInYear as v, searchCatalog as w, ratingFor as x, modelPickerMeta as y };
