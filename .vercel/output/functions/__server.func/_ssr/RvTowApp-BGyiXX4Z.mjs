...
import { O as RefreshCw, Y as Info, _t as ChevronDown, at as Eraser, c as Truck, yt as Car } from "../_libs/lucide-react.mjs";
import { u as cn } from "./routes-mAV4PuDv.mjs";
import { a as SuitePage } from "./SuitePage-KkbWK52y.mjs";
import { t as SelectSheet } from "./SelectSheet-CNDZQ8aW.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/RvTowApp-BGyiXX4Z.js
...
var TOW_MAKE_NAMES = TOW_MAKES.map((m) => m.name);
function getMake(name) {
	return TOW_MAKES.find((m) => m.name === name);
}
function getModels(make, kind = "all") {
...
function getRating(make, model, trimLabel) {
...
function makesForKind(kind) {
	if (kind === "all") return TOW_MAKE_NAMES;
	return TOW_MAKES.filter((m) => m.models.some((x) => x.kind === kind)).map((m) => m.name);
}
var YEARS = Array.from({ length: 22 }, (_, i) => String(2026 - i));
/** Towable RVs only — motorhomes are not towed by the selected vehicle. */
var RV_TYPES_TRUCK = ["Fifth Wheel", "Travel Trailer"];
var RV_TYPES_NON_TRUCK = ["Travel Trailer"];
/** Comfort / safety planning load (industry “80% rule”) vs OEM maximum. */
var RECOMMENDED_TOW_FACTOR = .8;
var RECOMMENDED_PAYLOAD_FACTOR = .85;
var BEDS = [
	"5.5 ft (Short Bed)",
	"6.5 ft (Standard Bed)",
	"8 ft (Long Bed)"
...
function RvTowApp() {
	...
	const [make, setMake] = (0, import_react.useState)("Ford");
	const [model, setModel] = (0, import_react.useState)("F-350 Super Duty");
	const [trim, setTrim] = (0, import_react.useState)("XL — 6.7L Power Stroke Diesel (SRW)");
	const [rvType, setRvType] = (0, import_react.useState)("Fifth Wheel");
	const [gvwr, setGvwr] = (0, import_react.useState)("14000");
	const [bed, setBed] = (0, import_react.useState)("6.5 ft (Standard Bed)");
	const [pin, setPin] = (0, import_react.useState)("");
	const [sheet, setSheet] = (0, import_react.useState)(null);
	const [manualMaxTow, setManualMaxTow] = (0, import_react.useState)("");
	const [manualPayload, setManualPayload] = (0, import_react.useState)("");
	const [manualGcwr, setManualGcwr] = (0, import_react.useState)("");
	const scrollRef = (0, import_react.useRef)(null);
	const makeList = (0, import_react.useMemo)(() => makesForKind(kindFilter), [kindFilter]);
	const models = (0, import_react.useMemo)(() => {
		if (!make) return [];
		return getModels(make, kindFilter === "all" ? "all" : kindFilter);
	}, [make, kindFilter]);
	const modelNames = (0, import_react.useMemo)(() => models.map((m) => m.name), [models]);
	const trims = (0, import_react.useMemo)(() => {
		if (!make || !model) return [];
		return getTrims(make, model);
	}, [make, model]);
	const trimLabels = (0, import_react.useMemo)(() => trims.map((t) => t.label), [trims]);
	const inCatalog = (0, import_react.useMemo)(() => {
	...
	const rating = (0, import_react.useMemo)(() => {
		...
		if (inCatalog && trim) return {
			...getRating(make, model, trim),
			custom: false
		};
		...
		return {
			maxTow,
			payload,
			gcwr: parseInt(manualGcwr, 10) || (maxTow && payload ? maxTow + payload + 5e3 : 0),
			hitch: "Owner-entered",
			kind: kindFilter === "suv" ? "suv" : "truck",
			label: "Custom entry",
			custom: true
		};
	}, [
	...
	const pinEst = pin ? parseInt(pin, 10) : Math.round(gvwrN * .2);
	const canTow = hasVehicle && rating.maxTow >= gvwrN;
	const pinOk = !hasVehicle || rvType !== "Fifth Wheel" || pinEst <= rating.payload;
	const margin = hasVehicle ? rating.maxTow - gvwrN : 0;
	/** Effective vehicle kind for RV-type rules */
	const vehicleIsTruck = !hasVehicle ? kindFilter !== "suv" : rating.kind === "truck" && kindFilter !== "suv";
	const rvTypeOptions = vehicleIsTruck ? [...RV_TYPES_TRUCK] : [...RV_TYPES_NON_TRUCK];
	/** Recommended continuous tow / payload (below OEM max). */
	const recommendedTow = hasVehicle ? Math.round(rating.maxTow * RECOMMENDED_TOW_FACTOR) : 0;
	const recommendedPayload = hasVehicle ? Math.round(rating.payload * RECOMMENDED_PAYLOAD_FACTOR) : 0;
	const withinRecommended = hasVehicle && gvwrN > 0 && gvwrN <= recommendedTow;
	const overRecommendedUnderMax = hasVehicle && gvwrN > recommendedTow && gvwrN <= rating.maxTow;
	...
	const truckCount = (0, import_react.useMemo)(() => makesForKind("truck").reduce((n, m) => n + getModels(m, "truck").length, 0), []);
	const suvCount = (0, import_react.useMemo)(() => makesForKind("suv").reduce((n, m) => n + getModels(m, "suv").length, 0), []);
	/** Change kind filter without fighting the user — keep selection if still valid */
	const applyKindFilter = (0, import_react.useCallback)((next) => {
		setKindFilter(next);
		if (next === "suv") setRvType("Travel Trailer");
		if (!make) return;
		if (getModels(make, next === "all" ? "all" : next).some((m) => m.name === model)) return;
		setModel("");
		setTrim("");
	}, [make, model]);
	const pickMake = (0, import_react.useCallback)((m) => {
		setMake(m);
		setManualMaxTow("");
		setManualPayload("");
		setManualGcwr("");
	...
	const pickModel = (0, import_react.useCallback)((m) => {
		setModel(m);
		setManualMaxTow("");
		setManualPayload("");
		setManualGcwr("");
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SuitePage, {
		tab: "rvtow",
		...
		overlays: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectSheet, {
				...
				onSelect: pickModel,
				onClose: () => setSheet(null),
				emptyHint: make ? "No catalog models — type yours below" : "Pick a make first",
				allowCustom: true,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectSheet, {
				...
				onSelect: setTrim,
				onClose: () => setSheet(null),
				emptyHint: model ? "No catalog trims — type yours or skip" : "Pick a model first",
				allowCustom: true,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectSheet, {
				open: sheet === "rvType",
				title: "RV Type",
				subtitle: vehicleIsTruck ? "5th wheel or travel trailer" : "Travel trailer only for non-trucks",
				items: rvTypeOptions,
				selected: rvType,
				onSelect: (v) => {
					if (!vehicleIsTruck) setRvType("Travel Trailer");
					else setRvType(v);
					setSheet(null);
				},
				onClose: () => setSheet(null)
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "flex items-center justify-end gap-1.5 px-3 pb-1 pt-1 sm:px-4",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Eraser, { className: "size-3" }), "Clear"]
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(RefreshCw, { className: "size-3" }), "Reset"]
			})]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "landscape-content mx-auto w-full max-w-lg space-y-3 px-3 pb-8 sm:px-4",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: [
						...
						className: cn("flex flex-1 items-center justify-center gap-1 rounded-full py-2 text-[12px] font-bold transition", kindFilter === id ? "bg-blue text-white shadow-[0_0_14px_rgba(77,166,255,0.35)]" : "text-white hover:text-white"),
						children: [
							id === "truck" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Truck, { className: "size-3.5" }) : id === "suv" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Car, { className: "size-3.5" }) : null,
							label,
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
					className: "glass-surface rounded-[var(--radius-xl)] p-3.5",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "mb-1 flex items-center gap-1.5 text-[12px] font-bold text-blue",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mb-3 text-[11px] text-white",
							children: "Tap any field · type your own if it's not listed · pull down to clear"
						}),
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, {
							...
							value: trim || (model ? inCatalog ? "Select or type trim" : "Type trim (optional)" : "Model first"),
							empty: !trim,
							disabled: !model,
							onClick: () => model && setSheet("trim")
						}),
						hasVehicle && rating.custom ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mt-3 space-y-2 rounded-[var(--radius-md)] border border-amber/35 bg-amber/10 px-3 py-3",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-[12px] font-bold text-amber",
									children: "Custom vehicle — enter door-sticker ratings"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
									...
									children: [
										...
										model,
										trim ? ` · ${trim}` : "",
										" is not in our OEM table. Type the max tow / payload from the sticker or owner's manual."
									]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												className: "mb-1 block text-[9px] font-bold tracking-wide text-blue",
												children: "MAX TOW"
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
												value: manualMaxTow,
												onChange: (e) => setManualMaxTow(e.target.value.replace(/\D/g, "")),
												placeholder: "lbs",
												inputMode: "numeric",
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												...
												value: manualPayload,
												onChange: (e) => setManualPayload(e.target.value.replace(/\D/g, "")),
												placeholder: "lbs",
												inputMode: "numeric",
												className: "w-full rounded-[var(--radius-md)] border border-border bg-black/40 px-2 py-2 text-sm text-white outline-none focus:border-blue/50"
											})]
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												...
												value: manualGcwr,
												onChange: (e) => setManualGcwr(e.target.value.replace(/\D/g, "")),
												placeholder: "lbs",
												inputMode: "numeric",
												className: "w-full rounded-[var(--radius-md)] border border-border bg-black/40 px-2 py-2 text-sm text-white outline-none focus:border-blue/50"
											})]
						...
						hasVehicle ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "mt-3 rounded-[var(--radius-md)] border border-blue/25 bg-blue/10 px-3 py-2.5",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
										className: "flex items-start gap-1.5 text-[12px] font-semibold text-white",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Info, { className: "mt-0.5 size-3.5 shrink-0 text-blue" }),
											year || "—",
											" ",
											make,
											" ",
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-0.5 pl-5 text-[11px] text-white",
										children: trim
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
										className: "mt-1 pl-5 text-[10px] font-semibold uppercase tracking-wide text-blue/90",
										children: [
											rating.kind === "suv" ? "SUV" : "Truck",
											" · ",
											rating.hitch,
											" ",
											"hitch"
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "mt-2 rounded-[var(--radius-md)] border border-emerald-400/30 bg-emerald-500/10 px-3 py-2.5",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "text-[10px] font-bold tracking-[0.12em] text-emerald-300",
										children: "RECOMMENDED TOW (PLANNING)"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "mt-1.5 grid grid-cols-2 gap-2",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "text-[18px] font-black tabular-nums text-white",
											children: fmtK(recommendedTow)
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
											className: "text-[10px] font-semibold leading-snug text-white",
											children: [
												"Rec. trailer ≤",
												" ",
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
													className: "font-bold text-white",
													children: [recommendedTow.toLocaleString(), " lbs"]
												}),
											...
											className: "text-[18px] font-black tabular-nums text-white",
											children: fmtK(recommendedPayload)
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
											className: "text-[10px] font-semibold leading-snug text-white",
											children: [
												"Rec. payload ≤",
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
													className: "font-bold text-white",
													children: [recommendedPayload.toLocaleString(), " lbs"]
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
													className: "font-medium text-white",
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-2 text-[10px] font-medium leading-relaxed text-white",
										children: "OEM max is the tested ceiling (e.g. SAE J2807 when equipped). Most guides plan trailers around ~80% of max tow so hills, wind, passengers, and gear stay inside a comfort margin."
									})
								]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "mt-2 text-[12px] font-semibold text-white",
								children: [
									"OEM Hitch:",
									" ",
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "font-bold text-blue",
										children: rating.hitch
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
										className: "font-semibold text-white",
										children: [" ", "· ratings when properly equipped"]
									})
								]
							})
						] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mt-3 rounded-[var(--radius-md)] border border-dashed border-white/20 bg-black/25 px-3 py-4 text-center",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "text-[13px] font-semibold text-white",
								children: "No vehicle selected"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-1 text-[11px] text-white",
								children: "Choose year · make · model · trim to see OEM tow ratings"
							})]
						})
					]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mb-3 text-[10px] font-bold tracking-[0.12em] text-blue",
							children: "RV DETAILS"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, {
							label: "RV TYPE",
							value: vehicleIsTruck ? rvType : "Travel Trailer (auto · non-truck)",
							onClick: () => {
								if (vehicleIsTruck) setSheet("rvType");
							},
							disabled: !vehicleIsTruck
						}),
						!vehicleIsTruck ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "mt-1.5 text-[11px] leading-relaxed text-sky-200/90",
							children: [
							...
							className: "mt-1.5 text-[11px] text-white",
							children: [
								"Truck: choose",
								" ",
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "mb-1 block text-[10px] font-bold tracking-[0.12em] text-blue",
									children: "RV GVWR (lbs) *"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
									value: gvwr,
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "mt-1 block text-[10px] text-white",
									children: "Gross Vehicle Weight Rating — from RV door sticker or spec sheet"
								})
							]
						}),
						rvType === "Fifth Wheel" && vehicleIsTruck && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "mt-2.5",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "mt-2 text-[11px] text-blue",
								children: [
									"Auto-estimating pin weight at ",
									pinEst.toLocaleString(),
									" lbs (20% of GVWR) · keep pin under ~",
									recommendedPayload.toLocaleString(),
									" ",
									"lbs recommended payload"
								]
							})
						] }),
						hasVehicle ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mt-3 space-y-2",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: cn("rounded-[var(--radius-md)] border px-3 py-3 text-sm font-semibold", canTow && pinOk ? "border-green/40 bg-green/10 text-green" : "border-ruby-border bg-ruby-soft text-ruby"),
									children: canTow && pinOk ? `✓ Within OEM max — ${margin.toLocaleString()} lb tow margin (${rating.maxTow.toLocaleString()} max vs ${gvwrN.toLocaleString()} GVWR)` : `⚠ Over OEM max — max tow ${rating.maxTow.toLocaleString()} lbs / payload ${rating.payload.toLocaleString()} lbs`
								}),
								canTow && withinRecommended ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "rounded-[var(--radius-md)] border border-emerald-400/35 bg-emerald-500/10 px-3 py-2.5 text-[12px] font-semibold text-emerald-100",
									children: [
										"✓ Within recommended planning weight (≤",
										" ",
										recommendedTow.toLocaleString(),
										" lbs / 80% of max)"
									]
								}) : null,
								canTow && overRecommendedUnderMax ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "rounded-[var(--radius-md)] border border-amber/40 bg-amber/10 px-3 py-2.5 text-[12px] font-semibold leading-relaxed text-amber",
									children: [
										"⚠ Above recommended ",
										recommendedTow.toLocaleString(),
										" lbs but under OEM max ",
										rating.maxTow.toLocaleString(),
										" lbs — legal when equipped, but little margin for hills, wind, or gear. Prefer a lighter trailer or higher-rated truck."
									]
								}) : null
							]
						}) : null,
						hasVehicle && rating.kind === "suv" && gvwrN > 8e3 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "mt-2 flex gap-1.5 text-[11px] leading-relaxed text-amber",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Info, { className: "mt-0.5 size-3.5 shrink-0" }), "Heavy trailers on SUVs need careful weight distribution, brake controller, and payload check (passengers + gear count against payload)."]
						}) : null
					]
				}),
				rvType === "Fifth Wheel" && vehicleIsTruck && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
					className: "glass-surface rounded-[var(--radius-xl)] p-3.5",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mb-3 text-[13px] font-bold text-blue",
						children: "5th Wheel: Pin Weight & Hitch Guide"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "px-1 text-center text-[10px] leading-relaxed text-white",
					children: "Max = OEM ceiling when properly equipped. Recommended ≈ 80% of max for real-world margin. SUV → Travel Trailer only. Verify door sticker."
				})
			]
		})]
	});
...
function Field({ label, value, onClick, empty, disabled }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "mt-2.5 first:mt-0",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "mb-1 text-[10px] font-bold tracking-[0.12em] text-blue",
			children: label
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			type: "button",
			onClick,
			disabled,
			className: cn("flex w-full items-center gap-2 rounded-[var(--radius-md)] border bg-black/40 px-3 py-3 text-left transition", disabled ? "cursor-not-allowed border-border/50 opacity-50" : "border-border active:scale-[0.99] active:border-blue/50"),
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: cn("min-w-0 flex-1 truncate text-sm font-medium", empty ? "text-white" : "text-white"),
				children: value
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { className: "size-4 shrink-0 text-white" })]
		})]
	});
}
function Stat({ value, sub }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "rounded-[var(--radius-md)] border border-blue/30 bg-blue/10 px-2 py-2.5 text-center",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "text-[20px] font-bold tabular-nums text-blue",
			children: value
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "mt-0.5 whitespace-pre-line text-[9px] leading-tight text-white",
			children: sub
		})]
	});
}
function GuideCard({ title, sub, pct, pros, cons, active }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: cn("rounded-[var(--radius-md)] border px-2.5 py-3", active ? "border-blue/40 bg-blue/10" : "border-border bg-black/30"),
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "text-center text-[12px] font-bold text-blue",
				children: title
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mt-1 text-center text-xl font-bold text-blue",
				children: pct
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "text-center text-[9px] text-white",
				children: "of trailer GVWR"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", {
				...
				children: [pros.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
					...
					children: ["✓ ", p]
				}, p)), cons.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
