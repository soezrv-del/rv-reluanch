...
import { A as Plus, F as MessageCircle, W as Landmark, bt as Bookmark, et as FileText, ht as Check, mt as ChevronDown, st as Copy, t as X, v as Sparkles, x as Share2 } from "../_libs/lucide-react.mjs";
import { c as hapticSuccess, l as useShellNavOptional, s as hapticLight, u as cn } from "./routes-D3fU4bnh.mjs";
import { a as SuitePage } from "./SuitePage-CblMnlwz.mjs";
import { d as formatMoney, f as formatPct, i as TERM_PRESETS, r as DOWN_PRESETS, s as computeLoan, u as defaultAprForTerm } from "./rvCal-CgEdg_DQ.mjs";
import { _ as getSpec, b as ratingFor, c as compareSelectionKey, g as getRatingMetadata, u as estimateMarket } from "./catalog-Dt-eFo6s.mjs";
import { t as buildBrochureSpecs } from "./brochureSpecs-C_RxgY8d.mjs";
import { n as mediaForRvType } from "./typeMedia-Cfrpq4yI.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/RvShareApp-z6Jst0JF.js
...
var SHARE_KIT_HEADER = "SpaceX AI-Powered RvFOX Report";
var SHARE_KIT_TAGLINE = "Know before you buy.";
var SHARE_KIT_FOOTER = "Prepared in RvFOX Powered By SpaceX. Confirm door sticker, PPI, and lender.";
var SHARE_KIT_CONTACT = "David Hansen 702-266-5918";
...
function kitStrengths(r, payment, ratingScore) {
	const b = coachBrochure(r);
	const meta = getRatingMetadata(r.make, r.model, r.year);
	const out = [];
	const score = ratingScore != null && Number.isFinite(ratingScore) && ratingScore > 0 ? ratingScore : meta.score;
	out.push(`${meta.tierLabel} · ${score.toFixed(1)} / 5.0 · ${meta.confidence} confidence`);
...
function coachSnapshot(r, ratingOverride) {
	const b = coachBrochure(r);
	const catalog = ratingFor(r.make, r.model, r.year);
	const rating = ratingOverride != null && Number.isFinite(ratingOverride) && ratingOverride > 0 ? ratingOverride : catalog;
	return {
		type: r.data.type || "",
...
function buildCoachKit(opts) {
	...
	if (include.payment && payment && payment.price > 0) {
		...
		if (Number.isFinite(payment.apr) && payment.apr > 0) lines.push(`Rate ${formatPct(payment.apr)}`);
	...
	if (include.strengths) {
		const clean = (opts.strengths ?? kitStrengths(r, include.payment ? payment : void 0, opts.rating)).map((s) => s.trim()).filter(Boolean);
		if (clean.length) {
			lines.push("");
...
function DraftNumberField({ label, value, onChange, prefix, suffix, min, max, decimals = 2 }) {
	const format = (n) => Number.isFinite(n) ? n.toFixed(decimals) : "";
	const [text, setText] = (0, import_react.useState)(() => format(value));
	const [focused, setFocused] = (0, import_react.useState)(false);
	(0, import_react.useEffect)(() => {
		if (focused) return;
		setText(Number.isFinite(value) ? value.toFixed(decimals) : "");
	}, [
		value,
		focused,
		decimals
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			...
			className: "glass-field flex min-h-11 items-center gap-1 rounded-[var(--radius-md)] px-2.5",
			children: [
				...
				suffix ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "shrink-0 text-[12px] font-bold text-white/60",
					children: suffix
				}) : null
			]
		})]
...
function RvShareApp({ active = true, onNavigate, onOpenGrok }) {
	...
	const [ratingEdit, setRatingEdit] = (0, import_react.useState)(null);
	...
	const catalogRating = (0, import_react.useMemo)(() => selected ? ratingFor(selected.make, selected.model, selected.year) : 0, [selected]);
	const ratingValue = ratingEdit ?? catalogRating;
	(0, import_react.useEffect)(() => {
		if (!selected || strengthsLocked) return;
		setStrengthDraft(kitStrengths(selected, include.payment ? payment : void 0, ratingValue));
	}, [
		selected,
		include.payment,
		payment,
	...
	const snap = (0, import_react.useMemo)(() => selected ? coachSnapshot(selected, ratingValue) : null, [selected, ratingValue]);
							...
							children: [
								...
								snap ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										...
										children: "COACH — RATING IS EDITABLE"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DraftNumberField, {
												label: "RATING ★",
												value: ratingValue,
								...
								include.payment ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "text-[9px] font-bold tracking-[0.16em] text-white/70",
											children: "PAYMENT — PRICE & RATE ARE EDITABLE"
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "grid grid-cols-2 gap-2",
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "flex items-center justify-between rounded-[var(--radius-md)] border border-white/15 bg-white/5 px-3 py-2.5",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
