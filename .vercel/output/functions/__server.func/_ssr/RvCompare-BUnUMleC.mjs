...
import { H as LoaderCircle, St as ArrowLeft, X as GitCompare, at as Download, c as Trophy, k as Printer, v as Sparkles } from "../_libs/lucide-react.mjs";
import { u as cn } from "./routes-D3fU4bnh.mjs";
import { i as SuiteBackdrop } from "./SuitePage-CblMnlwz.mjs";
import { f as findOemFloorplanSpec, s as unverifiedLayoutLabel } from "./router-Bq88JwJI.mjs";
import { b as ratingFor, c as compareSelectionKey, d as formatMoney, u as estimateMarket } from "./catalog-Dt-eFo6s.mjs";
import { t as buildBrochureSpecs } from "./brochureSpecs-C_RxgY8d.mjs";
import { a as liveMarketLadder, i as formatHardTorque, l as resolveHardPowertrain, n as fetchLiveDossier, o as mergeLiveIntoDisplay, r as formatHardHorsepower, s as peekVerifiedDossier, t as exportVehicleReport } from "./exportReport-Bq4nf4G-.mjs";
import { t as RV_CARD_MEDIA } from "./typeMedia-Cfrpq4yI.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/RvCompare-BUnUMleC.js
...
function RvCompare({ items, onBack, onOpen }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SuiteBackdrop, { src: RV_CARD_MEDIA }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mx-auto flex w-full max-w-2xl items-center justify-between gap-2 px-3 pb-2.5 sm:px-4",
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							...
							disabled: exportBusy,
							className: cn("inline-flex min-h-[44px] touch-manipulation items-center gap-1.5 rounded-full border border-white/25 bg-black/50 px-3 py-2 text-[12px] font-bold text-white active:scale-[0.97]", exportBusy && "opacity-70"),
