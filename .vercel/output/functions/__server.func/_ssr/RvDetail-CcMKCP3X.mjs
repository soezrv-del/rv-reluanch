...
import { H as LoaderCircle, L as MapPin, St as ArrowLeft, X as GitCompare, Y as Heart, et as FileText, k as Printer, l as TriangleAlert, lt as CircleCheck, tt as ExternalLink, v as Sparkles, vt as Calculator } from "../_libs/lucide-react.mjs";
import { l as useShellNavOptional, u as cn } from "./routes-DqDGUVQW.mjs";
import { i as SuiteBackdrop, n as SHARED_PRESTIGE_BACKDROP, s as usePullToReset, t as PullResetHint } from "./SuitePage-CG5Hg0RX.mjs";
import { t as fetchRecallsViaApi } from "./recalls-4yfzANbY.mjs";
import { c as findPowertrainCorrection, d as sanitizeNarrativeForPin, f as findOemFloorplanSpec, o as sanitizeUnverifiedLayout, u as sanitizeFeaturesForPin } from "./router-C-sy555R.mjs";
import { b as ratingFor, d as formatMoney, f as getFloorplansForYear, g as getRatingMetadata, p as getMaintenanceSchedule, u as estimateMarket, x as ratingStars } from "./catalog-Dt-eFo6s.mjs";
import { a as removeLocalSpecOverride, o as saveLocalSpecOverride, r as findLocalSpecOverride, t as buildBrochureSpecs } from "./brochureSpecs-Dn1cd2yY.mjs";
import { a as liveMarketLadder, c as refreshCoachDossierCache, i as formatHardTorque, l as resolveHardPowertrain, n as fetchLiveDossier, o as mergeLiveIntoDisplay, r as formatHardHorsepower, s as peekVerifiedDossier, t as exportVehicleReport } from "./exportReport-jWlSz1DR.mjs";
import { r as resolveCardImage } from "./typeMedia-Cfrpq4yI.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/RvDetail-CcMKCP3X.js
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mx-auto flex w-full max-w-lg flex-col gap-2 px-4 pb-2.5 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between sm:px-5",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
										...
										className: cn("inline-flex min-h-[44px] items-center gap-1.5 rounded-full border px-3 py-2 text-[12px] font-bold", saved ? "border-ruby/50 bg-ruby/25 text-white" : "border-white/20 bg-black/40 text-white"),
									...
									onToggleCompare ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
										...
										className: cn("inline-flex min-h-[44px] items-center gap-1.5 rounded-full border px-3 py-2 text-[12px] font-bold disabled:opacity-40", comparing ? "border-sky-400/50 bg-sky-500/20 text-sky-100" : "border-white/20 bg-black/40 text-white"),
