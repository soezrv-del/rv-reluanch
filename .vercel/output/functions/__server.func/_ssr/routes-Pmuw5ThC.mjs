...
import { I as MessageCircle, R as MapPin, b as Shield, bt as Calculator, gt as ChevronDown, nt as FileText, s as Truck, x as Share2 } from "../_libs/lucide-react.mjs";
import { C as __exportAll } from "./router-Ba5nxcdr.mjs";
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/routes-Pmuw5ThC.js
...
var TOOLS = [
	...
	},
	{
		id: "rvshare",
		title: "RvShare",
		blurb: "Send a coach kit — specs, payment, lifestyle, report",
		Icon: Share2
	},
	{
		id: "rvgrok",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "min-h-0 flex-1 overflow-y-auto overscroll-contain rounded-[1.5rem] border border-white/22 bg-white/[0.03] p-1.5 shadow-[0_8px_32px_rgba(0,0,0,0.18)] backdrop-blur-[1.5px]",
							children: TOOLS.map((item, index) => {
								...
								return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
									...
									className: cn("flex w-full items-center gap-3 rounded-[1.15rem] px-3 py-2 text-left transition-all duration-300 ease-out touch-manipulation", active ? "scale-[1.01] bg-gradient-to-r from-sky-500/90 via-blue-500/85 to-blue-600/90 shadow-[0_0_28px_rgba(56,140,255,0.45)]" : "bg-transparent hover:bg-white/[0.07]"),
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
function measure() {
	...
	const fieldFocused = typeof document !== "undefined" && isTextField(document.activeElement);
...
function applyCssVars(k) {
	...
	const frameH = k.vvHeight > 0 ? k.vvHeight : typeof window !== "undefined" ? window.innerHeight : 0;
	root.style.setProperty("--kb-inset", `${k.inset}px`);
	if (frameH > 0) root.style.setProperty("--vv-height", `${Math.round(frameH)}px`);
...
function BottomTabs({ tab, onChange }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
		...
		"data-active-tab": tab,
		style: { paddingBottom: "min(10px, max(6px, env(safe-area-inset-bottom, 0px)))" },
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: cn("bottom-tabs-dock pointer-events-auto relative mx-auto grid w-full max-w-lg grid-cols-6 items-stretch gap-0 overflow-hidden rounded-[1.7rem] p-1", grokActive && "bottom-tabs-dock-ruby"),
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					"aria-hidden": true,
				...
				TABS.map(({ id, label, short, iconSrc }) => {
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						"aria-label": label,
						title: label,
						className: cn("bottom-tab-btn group relative z-[3] flex min-h-[52px] w-full flex-col items-center justify-center gap-0.5 rounded-[1.25rem] px-0 py-1 sm:min-h-[56px]", "transition-[transform,opacity] duration-200 ease-out", "active:scale-[0.94] touch-manipulation select-none"),
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
									src: iconSrc,
									alt: "",
									className: cn("bottom-tab-icon size-[20px] object-contain sm:size-6", active && "drop-shadow-[0_0_10px_rgba(160,210,255,0.55)]", isGrok && active && "drop-shadow-[0_0_10px_rgba(255,90,110,0.55)]"),
									draggable: false
								})
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: cn("bottom-tab-label text-center text-[8.5px] font-semibold uppercase leading-none tracking-[0.1em] sm:text-[10px] sm:tracking-[0.14em]", isGrok ? active ? "text-[#ffd0d6]" : "text-white/45" : active ? "text-sky-50" : "text-white/45"),
								children: short
							}),
...
*/
var RvFaxApp = (0, import_react.lazy)(() => import("./RvFaxApp-CHqoKcpV.mjs").then((m) => ({ default: m.RvFaxApp })));
var RvGrokApp = (0, import_react.lazy)(() => import("./RvGrokApp-CK-5WbTD.mjs").then((m) => ({ default: m.RvGrokApp })));
var RvTowApp = (0, import_react.lazy)(() => import("./RvTowApp-BvAZelOg.mjs").then((m) => ({ default: m.RvTowApp })));
var RvCalApp = (0, import_react.lazy)(() => import("./RvCalApp-CDdcqXwB.mjs").then((m) => ({ default: m.RvCalApp })));
var RvTripsApp = (0, import_react.lazy)(() => import("./RvTripsApp-VEo3dqg4.mjs").then((m) => ({ default: m.RvTripsApp })));
var RvShareApp = (0, import_react.lazy)(() => import("./RvShareApp-D01F4YcF.mjs").then((m) => ({ default: m.RvShareApp })));
var MoreApp = (0, import_react.lazy)(() => import("./MoreApp-B9obbZdY.mjs").then((m) => ({ default: m.MoreApp })));
var TAB_PANE_ON = "absolute inset-0 flex min-h-0 flex-col overflow-hidden";
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_react.Suspense, {
						...
						children: [
							show("rvgrok") ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: tab === "rvgrok" ? TAB_PANE_ON : "hidden",
							...
							show("rvfax") ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: tab === "rvfax" ? TAB_PANE_ON : "hidden",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SuiteErrorBoundary, {
									name: "RvFACTS",
							...
							show("rvcal") ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: tab === "rvcal" ? TAB_PANE_ON : "hidden",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SuiteErrorBoundary, {
									name: "RvCAL",
							...
							show("rvtow") ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: tab === "rvtow" ? TAB_PANE_ON : "hidden",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SuiteErrorBoundary, {
									name: "RvTOW",
							...
							show("rvtrips") ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: tab === "rvtrips" ? TAB_PANE_ON : "hidden",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SuiteErrorBoundary, {
									name: "RvTRIPS",
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RvTripsApp, {})
								})
							}) : null,
							show("rvshare") ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: tab === "rvshare" ? TAB_PANE_ON : "hidden",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SuiteErrorBoundary, {
									name: "RvSHARE",
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RvShareApp, {
							...
							show("more") ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: tab === "more" ? TAB_PANE_ON : "hidden",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SuiteErrorBoundary, {
									name: "More",
...
//#endregion
export { PAGE_COPY as a, hapticSnap as c, cn as d, formatRelativeTime as f, PAGE_ACCENT as i, hapticSuccess as l, uid as m, scrollFieldIntoVisibleArea as n, MetalVerifiedTrue as o, formatTime as p, useKeyboardInset as r, hapticLight as s, routes_exports as t, useShellNavOptional as u };
