# RV Facts Catalog — Active Daily Update (v5 + Phase 3)

**Target:** July-28 RVFAX codebase (`code 8:28.zip`)  
**Date:** 2026-08-27 (v6 — grok-4-latest + Facts mount wiring)  

## What “actively update” means

Once per day the system:

1. **New-model scan** — asks Grok for every distinct model line in active production for the **next year + current year + prior year** across priority manufacturers.
