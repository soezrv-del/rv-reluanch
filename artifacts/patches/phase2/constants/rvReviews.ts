// ─── RV Review pools (split from rvData for faster first paint) ───────────────
// Imported only by detail/PDF paths, not required for search wizard boot.
...
export type ReviewTemplate = Omit<RVReview, 'id' | 'rating'>;

export const BRAND_REVIEW_POOLS: Record<string, ReviewTemplate[]> = {
  'Thor Challenger': [
