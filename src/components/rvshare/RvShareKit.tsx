...
/** Brochure Share kit — lives inline at the bottom of a Facts report. */
export function RvShareKit({
  result,
  onAskGrok,
}: {
  result: RVResult;
  ...
  return (
    <section
      ...
      className="space-y-3"
    >
      <div className="glass-prestige-gold relative overflow-hidden rounded-[1.25rem] p-4">
        ...
        <p className="mt-1 text-[12px] leading-relaxed text-white/75">
          Brochure summary — send from this report.
        </p>
