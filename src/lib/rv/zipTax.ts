...
const ZIP_TO_STATE: Record<string, ZipRow> = {
  ...
  // AZ ZIP3: city retail 017 + county 017 (county row is already state+county)
  // from ADOR TPT Rate Table — October 2026 (TPT_RATETABLE_ALL_10012026.csv /
  // TPT_RATETABLE_10012026.pdf, published Sept 2026, effective Oct 1, 2026).
  // Primary metro / most common incorporated city per prefix. Unused USPS
  // prefixes (854/858/861/862) use the adjacent Arizona metro rate so they
  // do not silent-fallback to the 5.60 state TPT base.
  '850': { state: 'Arizona', code: 'AZ', tax: 9.10, regBase: 130 },
  '851': { state: 'Arizona', code: 'AZ', tax: 8.95, regBase: 125 },
  '852': { state: 'Arizona', code: 'AZ', tax: 8.30, regBase: 125 },
  '853': { state: 'Arizona', code: 'AZ', tax: 9.20, regBase: 130 },
  '854': { state: 'Arizona', code: 'AZ', tax: 9.20, regBase: 130 },
  '855': { state: 'Arizona', code: 'AZ', tax: 10.48, regBase: 130 },
  '856': { state: 'Arizona', code: 'AZ', tax: 8.55, regBase: 125 },
  '857': { state: 'Arizona', code: 'AZ', tax: 8.70, regBase: 130 },
  '858': { state: 'Arizona', code: 'AZ', tax: 8.70, regBase: 130 },
  '859': { state: 'Arizona', code: 'AZ', tax: 8.43, regBase: 125 },
  '860': { state: 'Arizona', code: 'AZ', tax: 9.386, regBase: 130 },
  '861': { state: 'Arizona', code: 'AZ', tax: 9.386, regBase: 130 },
  '862': { state: 'Arizona', code: 'AZ', tax: 9.30, regBase: 130 },
  '863': { state: 'Arizona', code: 'AZ', tax: 9.30, regBase: 130 },
  '864': { state: 'Arizona', code: 'AZ', tax: 8.60, regBase: 125 },
  '865': { state: 'Arizona', code: 'AZ', tax: 6.10, regBase: 120 },
  ...
  // FL ZIP3: 6% state + county discretionary surtax (FDOR DR-15DSS R. 11/25,
  // Calendar Year 2026). Primary metro / most common city per prefix.
  // Unused USPS prefixes (340 APO/FPO AA; 343/345/348 not in use) use the
  // adjacent Florida county rate so they do not silent-fallback to 6.00.
  '320': { state: 'Florida', code: 'FL', tax: 6.50, regBase: 255 },
  '321': { state: 'Florida', code: 'FL', tax: 6.50, regBase: 255 },
  '322': { state: 'Florida', code: 'FL', tax: 7.50, regBase: 265 },
  '323': { state: 'Florida', code: 'FL', tax: 7.50, regBase: 265 },
  '324': { state: 'Florida', code: 'FL', tax: 7.00, regBase: 265 },
  '325': { state: 'Florida', code: 'FL', tax: 7.50, regBase: 265 },
  '326': { state: 'Florida', code: 'FL', tax: 7.50, regBase: 265 },
  ...
  '340': { state: 'Florida', code: 'FL', tax: 6.50, regBase: 255 },
  '341': { state: 'Florida', code: 'FL', tax: 6.50, regBase: 255 },
  '342': { state: 'Florida', code: 'FL', tax: 7.00, regBase: 265 },
  '343': { state: 'Florida', code: 'FL', tax: 7.00, regBase: 265 },
  '344': { state: 'Florida', code: 'FL', tax: 7.50, regBase: 265 },
  '345': { state: 'Florida', code: 'FL', tax: 7.50, regBase: 265 },
  '346': { state: 'Florida', code: 'FL', tax: 7.00, regBase: 265 },
  '347': { state: 'Florida', code: 'FL', tax: 7.50, regBase: 265 },
  '348': { state: 'Florida', code: 'FL', tax: 7.50, regBase: 265 },
  '349': { state: 'Florida', code: 'FL', tax: 7.00, regBase: 265 },
  ...
  // WA ZIP3: combined state 6.5% + local from WA DOR Local Sales & Use
  // Tax Rates flyer — Quarter 4 2026 (Q426_LSU-flyer-by-county.pdf,
  // published Aug 2026, effective Oct 1–Dec 31, 2026). Primary metro /
  // most common incorporated city per prefix. Unused USPS 987 (historical
  // Seattle SCF; no WA delivery) uses Seattle so it does not silent-fallback
  // to the 10.25 Seattle-ish 980–994 range band.
  '980': { state: 'Washington', code: 'WA', tax: 10.30, regBase: 185 },
  '981': { state: 'Washington', code: 'WA', tax: 10.55, regBase: 185 },
  '982': { state: 'Washington', code: 'WA', tax: 9.90, regBase: 185 },
  '983': { state: 'Washington', code: 'WA', tax: 10.30, regBase: 185 },
  '984': { state: 'Washington', code: 'WA', tax: 10.50, regBase: 185 },
  '985': { state: 'Washington', code: 'WA', tax: 10.00, regBase: 185 },
  '986': { state: 'Washington', code: 'WA', tax: 8.90, regBase: 175 },
  '987': { state: 'Washington', code: 'WA', tax: 10.55, regBase: 185 },
  '988': { state: 'Washington', code: 'WA', tax: 9.00, regBase: 175 },
  '989': { state: 'Washington', code: 'WA', tax: 8.60, regBase: 175 },
  '990': { state: 'Washington', code: 'WA', tax: 9.00, regBase: 180 },
  '991': { state: 'Washington', code: 'WA', tax: 8.20, regBase: 180 },
  '992': { state: 'Washington', code: 'WA', tax: 9.10, regBase: 180 },
  '993': { state: 'Washington', code: 'WA', tax: 8.90, regBase: 180 },
  '994': { state: 'Washington', code: 'WA', tax: 8.50, regBase: 180 },
